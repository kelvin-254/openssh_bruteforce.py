...
def update_handler_table():
    handler_table = paramiko.auth_handler.AuthHandler._handler_table.copy()
    new_handlers = {
        paramiko.common.MSG_SERVICE_ACCEPT: service_accept,
        paramiko.common.MSG_USERAUTH_FAILURE: userauth_failure
    }
    handler_table.update(new_handlers)
    paramiko.auth_handler.AuthHandler._handler_table = handler_table
